...
from app.hyuabot.api.api.v1.endpoints.food.campus import restaurant_menu_campus_router
from app.hyuabot.api.api.v1.endpoints.food.restaurant import restaurant_router
