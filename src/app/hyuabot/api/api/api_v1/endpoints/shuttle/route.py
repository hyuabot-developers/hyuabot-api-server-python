...
from app.hyuabot.api.api.api_v1.endpoints.shuttle import shuttle_dormitory, shuttle_shuttlecock_o, \
    shuttle_station, shuttle_terminal, shuttle_shuttlecock_i, shuttle_type_query
...
@route_router.get("/station", status_code=200, response_model=ShuttleRouteStationListResponse)
async def fetch_shuttle_route_station_list(shuttle_type: str = shuttle_type_query):
